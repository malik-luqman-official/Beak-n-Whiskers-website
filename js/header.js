    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarButtonsExample">
        ...
        <div class="d-flex align-items-center mr-3">
          ...
          <a id="loginBtn" data-mdb-ripple-init type="button" class="px-3 me-2" href="sign-in.html">
            Sign In
          </a>
           <a href="choose-your-role.html"><button id="signupBtn" data-mdb-ripple-init type="button" class="main-button" >
           Sign up for free
          </button></a>
...
function updateNavbar() {
  ...
  if (isLoggedIn) {
    ...
    document.getElementById('userDropdown').querySelector('a').textContent = user?.fullName || 'User';
  }
}
